...
// Keep all your other routes (register-patient, forgot-password, patients, appointments, email/send, patient routes, etc.)
// They are already in your file — just make sure sendEmail is used in the appointment and email routes.
